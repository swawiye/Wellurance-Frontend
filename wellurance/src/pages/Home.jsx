                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-300 hover:text-amber-600 transition">Services</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-amber-600 transition">About Us</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-amber-600 transition">Contact</a></li>
                        </ul>
                    </div>
